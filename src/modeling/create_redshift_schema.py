...
CREATE_NEWS_SENTIMENT = """
    CREATE TABLE IF NOT EXISTS news_sentiment (
        symbol              VARCHAR(10)     NOT NULL    ENCODE lzo,
        date                DATE            NOT NULL    ENCODE az64,
        headline            VARCHAR(500)    NOT NULL    ENCODE lzo,
        sentiment_score     NUMERIC(5,4)    NOT NULL    ENCODE az64,
        source              VARCHAR(500)                ENCODE lzo,
        url                 VARCHAR(500)    NOT NULL    ENCODE lzo
    )
    DISTKEY (symbol)
    SORTKEY (date);
"""
...
CREATE_STAGING_NEWS_SENTIMENT = """
    CREATE TABLE IF NOT EXISTS staging_news_sentiment (
        symbol              VARCHAR(10)     NOT NULL    ENCODE lzo,
        date                DATE            NOT NULL    ENCODE az64,
        headline            VARCHAR(500)    NOT NULL    ENCODE lzo,
        sentiment_score     NUMERIC(5,4)    NOT NULL    ENCODE az64,
...
def create_redshift_schema():
    ...
    try:
        ...
        logger.info("Creating news sentiment table in Redshift...")
        cursor.execute(CREATE_NEWS_SENTIMENT)
        ...
        cursor.execute(CREATE_STAGING_NEWS_SENTIMENT)
        conn.commit()
